export default function Skills(){
    return(
        <div className="h-[90vh] flex-col mb-20">
            ...
            <div className="shadow-violet-500 mr-5 rounded-xl shadow-lg hover:shadow-2xl duration-200 ease-in w-100  py-10 px-5 mt-10 max-w-xl text-left bg-gradient-to-b from-white to-gray-100 hover:bg-gradient-to-t duration-400 ease-in">
